...
class Tenant:
    ...
    def allow_password_sign_up(self):
        return self._data.get('allowPasswordregister', False)
...
class _TenantManagementService:
    ...
    def create_tenant(
        ...
        if allow_password_sign_up is not None:
            payload['allowPasswordregister'] = _auth_utils.validate_boolean(
                allow_password_sign_up, 'allowPasswordregister')
